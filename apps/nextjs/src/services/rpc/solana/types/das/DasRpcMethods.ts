export type DasRpcMethods = {
    getAssetsByOwner: (request: DAS.AssetsByOwnerRequest) => Readonly<DAS.GetAssetResponseList>;
    getAssetsByCreator: (request: DAS.AssetsByCreatorRequest) => Readonly<DAS.GetAssetResponseList>;
    getAssetBatch: (request: DAS.GetAssetBatchRequest) => Readonly<DAS.GetAssetResponseList>;
    getAssetsByGroup: (request: DAS.AssetsByGroupRequest) => Readonly<DAS.GetAssetResponseList>;
    getAssetsBatch: (request: DAS.GetAssetsBatchRequest) => Readonly<DAS.GetAssetResponseList>;
    searchAssets: (request: DAS.SearchAssetsRequest) => Readonly<DAS.GetAssetResponseList>;
    getAssetsByAuthority: (request: DAS.AssetsByAuthorityRequest) => Readonly<DAS.GetAssetResponseList>;
    getAsset: (request: DAS.GetAssetRequest) => Readonly<DAS.GetAssetResponse>;
    getRwaAsset: (request: DAS.GetRwaAssetRequest) => Readonly<DAS.GetAssetResponse>;
    getAssetProof: (request: DAS.GetAssetProofRequest) => Readonly<DAS.GetAssetProofResponse>;
    getSignaturesForAsset: (request: DAS.GetSignaturesForAssetRequest) => Readonly<DAS.GetSignaturesForAssetResponse>;
};
